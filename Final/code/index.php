					...
					<div class="slider-content">
						...
						<div class="text">      <!-- jquery typed effect -->
							...
							<div class="social-networks">
								<a href="https://www.facebook.com/rafi.ahmed.967422/" class="fa fa-facebook"></a>
								<a href="https://twitter.com" class="fa fa-twitter"></a>
								<a href="https://www.instagram.com" class="fa fa-instagram"></a>
								<a href="" class="fa fa-reddit"></a>
								<a href="https://www.facebook.com/rafi.ahmed.967422/" class="fa fa-linkedin"></a>
         	...
         	<div class="row">
         		...
         		<div class="col-md-4 col-sm-6 col-xs-12">
         			<div class="service-wrap text-center">
         				...
         				<h3><a href="index.php">EXERCISE</a></h3>   <!--  exercise/exercise.php -->
         				<p>
				...
				<div class="row">
					<div class="col-md-12">
						<div id="team-memebers" class="owl-carousel owl-theme">
							...
							<img src="img/rafi.jpg" class="img-responsive">
								<div class="team-member-info text-center">
									<h4 class="team-member-name">Rafi Ahmed</h4>
									<h4 class="team-member-designation">ceo</h4>
									<ul class="social-list">
										<li><a href="https://www.facebook.com/rafi.ahmed.967422/" class="social-icon icon-gray"><i class="fa fa-facebook"></i></a></li>
							...
							<?php } ?>
								...
								<div class="panel panel-default">
									...
									<div id="collapseTwo" class="panel-collapse collapse" aria-labelledby="headingTwo">
										<div class="panel-body">
											<p>
												e-learning is an online learning website <br>
